#ifndef GEOMETRY_GENERATORS_H
#define GEOMETRY_GENERATORS_H
...
namespace asr::geometry_generators
{
    ...
    static geometry_data_type generate_rectangle_geometry_data(
    ...
    static geometry_data_type generate_box_geometry_data(
